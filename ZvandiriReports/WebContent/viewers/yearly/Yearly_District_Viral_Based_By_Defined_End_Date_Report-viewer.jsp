...
java.util.Date" %><%
	...
	try {
		...
		String reportName = "Reports/Yearly_District_Viral_Based_By_Defined_End_Date_Report.rpt";
		...
		// ****** BEGIN CONNECT CRYSTALREPORTPAGEVIEWER SNIPPET ****************  
		{
			...
			crystalReportPageViewer.setName("Yearly_District_Viral_Based_By_Defined_End_Date_Report");
...
<title>Yearly_District_Viral_Based_By_Defined_End_Date_Report</title>