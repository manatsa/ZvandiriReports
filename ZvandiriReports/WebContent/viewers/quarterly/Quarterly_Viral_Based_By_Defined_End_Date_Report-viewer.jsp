...
java.util.Date" %><%
	...
	try {
		...
		String reportName = "Reports/Quarterly_Viral_Based_By_Defined_End_Date_Report.rpt";
		...
		// ****** BEGIN CONNECT CRYSTALREPORTPAGEVIEWER SNIPPET ****************  
		{
			...
			crystalReportPageViewer.setName("Quarterly_Viral_Based_By_Defined_End_Date_Report");
...
<title>Quarterly_Viral_Based_By_Defined_End_Date_Report</title>