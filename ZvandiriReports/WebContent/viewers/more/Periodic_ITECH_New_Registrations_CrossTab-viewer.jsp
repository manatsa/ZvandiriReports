...
java.util.Date" %><%
	...
	try {
		...
		String reportName = "Reports/Periodic_ITECH_New_Registrations_CrossTab.rpt";
		...
		// ****** BEGIN CONNECT CRYSTALREPORTPAGEVIEWER SNIPPET ****************  
		{
			...
			crystalReportPageViewer.setName("Periodic_ITECH_New_Registrations_CrossTab");
...
<title>Periodic_ITECH_New_Registrations_CrossTab</title>