...
java.util.Date" %><%
	...
	try {
		...
		String reportName = "Reports/Periodic_Clients_Without_Contacts_Age_group_CrossTab.rpt";
		...
		if (clientDoc == null) {
			...
			// ****** BEGIN CONNECT PARAMETERS SNIPPET ****************		
			{
				...
				CRJavaHelper.addDiscreteParameterValue(clientDoc, "", "end_date", dateParamVal);
			}
			{
				// DATE VALUE PARAMETER.
				Calendar calendar = Calendar.getInstance();
				calendar.set(2020, 1, 1);
				Date dateParamVal = calendar.getTime();	// TODO: Fill in value
				CRJavaHelper.addDiscreteParameterValue(clientDoc, "", "start_date", dateParamVal);
			}
		...
		// ****** BEGIN CONNECT CRYSTALREPORTPAGEVIEWER SNIPPET ****************  
		{
			...
			crystalReportPageViewer.setName("Periodic_Clients_Without_Contacts_Age_group_CrossTab");
...
<title>Periodic_Clients_Without_Contacts_Age_group_CrossTab</title>