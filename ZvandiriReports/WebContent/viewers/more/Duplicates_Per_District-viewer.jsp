...
com.crystaldecisions.sdk.occa.report.lib.ReportSDKExceptionBase" %><%
	...
	try {
		...
		String reportName = DBUtils.location+"Duplicates_Per_District.rpt";
		...
		if (clientDoc == null) {
			...
			// ****** BEGIN CONNECT PARAMETERS SNIPPET ****************		
			{
				...
				CRJavaHelper.addDiscreteParameterValue(clientDoc, "", "district", stringValue);
			}
		...
		// ****** BEGIN CONNECT CRYSTALREPORTPAGEVIEWER SNIPPET ****************  
		{
			...
			crystalReportPageViewer.setName("Duplicates_Per_District");
...
%>
<title>Duplicates_Per_District</title>