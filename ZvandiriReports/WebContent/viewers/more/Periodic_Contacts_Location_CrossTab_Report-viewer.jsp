...
java.util.Date" %><%
	...
	try {
		...
		String reportName = DBUtils.location+"Periodic_Contacts_Location_CrossTab_Report.rpt";
		...
		// ****** BEGIN CONNECT CRYSTALREPORTPAGEVIEWER SNIPPET ****************  
		{
			...
			crystalReportPageViewer.setName("Periodic_Contacts_Location_CrossTab_Report");
...
<title>Periodic_Contacts_Location_CrossTab_Report</title>