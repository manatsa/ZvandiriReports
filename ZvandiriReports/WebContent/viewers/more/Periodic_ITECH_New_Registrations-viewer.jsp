...
java.util.Date" %><%
	...
	try {
		...
		String reportName = "Reports/Periodic_ITECH_New_Registrations.rpt";
		...
		// ****** BEGIN CONNECT CRYSTALREPORTPAGEVIEWER SNIPPET ****************  
		{
			...
			crystalReportPageViewer.setName("Periodic_ITECH_New_Registrations");
...
<title>Periodic_ITECH_New_Registrations</title>