...
java.util.Date" %><%
	...
	try {
		...
		String reportName = DBUtils.location+"Monthly_Contacts_Location_CrossTab_Report.rpt";
		...
		// ****** BEGIN CONNECT CRYSTALREPORTPAGEVIEWER SNIPPET ****************  
		{
			...
			crystalReportPageViewer.setName("Monthly_Contacts_Location_CrossTab_Report");
...
%>
<title>Monthly Contacts Location CrossTab</title>