...
java.util.Date" %><%
	...
	try {
		...
		String reportName = "Reports/Monthly_ITECH_CLIENTS_STATUS_CrossTab_Report.rpt";
		...
		// ****** BEGIN CONNECT CRYSTALREPORTPAGEVIEWER SNIPPET ****************  
		{
			...
			crystalReportPageViewer.setName("Monthly_ITECH_CLIENTS_STATUS_CrossTab_Report");
...
<title>Monthly_ITECH_CLIENTS_STATUS_CrossTab_Report</title>